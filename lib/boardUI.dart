...
topBar(BuildContext context) {
  bool buttonUp = Provider.of<BoardProvider>(context, listen: true).costs;
  return Padding(
      ...
      children: [
        GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            width: 40,
            decoration: BoxDecoration(
              color: buttonUp ? Colors.white10 : Colors.white24,
              borderRadius: BorderRadius.circular(5),
            ),
            child: Center(
              child: Icon(
        ...
        GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            child: Center(
              child: Icon(
                buttonUp ? Icons.money_off_rounded : Icons.attach_money_rounded,
              ),
            ),
          ),
        ),
...
_getBoardAsRow(BuildContext context) {
  return Row(
    children: [
      //FIRST COLUMN
    ...
    child: Column(
      children: [
        ...
        Expanded(
          flex: innerFlex,
          child: Container(
            child: const Center(child: Icon(Icons.emoji_emotions_sharp)),
          ),
        ),
        //BOT ROW --------------------------------------------------------------
        Expanded(
